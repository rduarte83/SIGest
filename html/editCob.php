...
<head>
    ...
    <title>SIGest | Editar Cobrança</title>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="cobrancas.php">Lista de Cobranças</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title">Dados da Cobrança</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form action="visitas.php" method="post" id="addForm" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="card-footer">
                            ...
                            <input type="hidden" name="op" value="editCob">
...
<script src="../js/editCob.js"></script>
</body>
</html>
